...
t5 =
  ...
  [Group 1
   [Group 14
    ...
    ,Synth 1401 "cehoge" ["t_trig":<-141]
    ,Synth 1402 "cehoge" ["t_trig":<-142,"flo":=440,"fhi":=1320]
    ,Synth 1403 "cehoge" ["t_trig":<-141,"flo":=180,"fhi":=320]]]]
  ...
  [Group 1
   [Group 14
    [Group 141
     ...
     ,Synth 1411 "lftrig" ["freq":=2,"out":=142]]
    ,Synth 1401 "cehoge" ["t_trig":<-141]
    ,Synth 1402 "cehoge" ["t_trig":<-142,"flo":=880,"fhi":=1320,"prob":=0.9]
    ,Synth 1403 "cehoge" ["t_trig":<-141,"flo":=180,"fhi":=320,"prob":=1]
    ,Synth 1404 "cehoge" ["t_trig":<-142,"flo":=660,"fhi":=770,"prob":=0.25]]]]
...
t00 =
  Group 0
    [Group 2
      [Group 20
        [Synth 2000 "cefoo" ["amp":=0.3,"freq":=440,"out":=0]
        ,Synth 2001 "cefoo" ["amp":=0.3,"freq":=330,"out":=0]]]]
...
t01 =
  Group 0
    [Group 2
      [Group 20
        [Synth 2000 "cefoo" ["amp":=0.3,"freq":=880,"out":=0]
        ,Synth 2001 "cefoo" ["amp":=0.3,"freq":=330,"out":=0]]]]
  ...
  Group 0
    [Group 2
      [Group 20
        [Synth 2000 "cefoo" ["amp":=0.3,"freq":=440,"out":=0]
        ,Synth 2001 "cefoo" ["amp":=0.3,"freq":=330,"out":=0]
        ,Synth 2002 "cefoo" ["amp":=0.3,"freq":=1320,"out":=0]]]]
...
t04 =
  Group 0
    [Group 2
      [Group 20
        [Synth 2000 "cefoo" ["amp":=0.3,"freq":=550,"out":=0]
        ,Synth 2001 "cefoo" ["amp":=0.3,"freq":=330,"out":=0]
        ,Synth 2002 "cefoo" ["amp":=0.3,"freq":=1320,"out":=0]]]]
...
t05 =
  Group 0
    [Group 2
      [Group 20
        [Synth 2001 "cefoo" ["amp":=0.3,"freq":=660,"out":=0]
        ,Synth 2002 "cefoo" ["amp":=0.3,"freq":=990,"out":=0]
        ,Synth 2003 "cefoo" ["amp":=0.3,"freq":=880,"out":=0]]]]
...
t07 =
  Group 0
    [Group 2
      [Group 20
        [Synth 2000 "cebar" ["amp":=0.3,"freq":=2800,"out":=0]
        ,Synth 2001 "cefoo" ["amp":=0.3,"freq":=330,"out":=0]]]]
...
u00 =
  Group 0
    [Group 2
       [Group 20
          [Synth 2000 "cefoo" ["amp":=0.2,"freq":=330,"out":=0]
          ,Synth 2001 "cefoo" ["amp":=0.2,"freq":=333,"out":=0]]
       ,Group 21
          [Synth 2100 "cefoo" ["amp":=0.2,"freq":=440,"out":=0]
          ,Synth 2101 "cefoo" ["amp":=0.2,"freq":=439,"out":=0]]
       ,Group 22
          [Synth 2200 "cefoo" ["amp":=0.2,"freq":=440,"out":=0]
          ,Synth 2201 "cefoo" ["amp":=0.2,"freq":=439,"out":=0]]
       ,Group 23
          [Synth 2300 "cefoo" ["amp":=0.2,"freq":=660,"out":=0]
          ,Synth 2301 "cefoo" ["amp":=0.2,"freq":=670,"out":=0]]]]
  ...
  Group 0
    [Group 2
       ...
       ,Group 21
          ...
          ,Synth 2101 "cefoo" ["amp":=0.2,"freq":=439,"out":=0]]
       ,Group 22
          [Synth 2200 "cefoo" ["amp":=0.2,"freq":=660,"out":=0]
          ,Synth 2201 "cefoo" ["amp":=0.2,"freq":=670,"out":=0]]]]
